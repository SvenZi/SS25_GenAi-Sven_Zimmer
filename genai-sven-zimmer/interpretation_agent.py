...
def create_interpretation_agent() -> Agent:
    RESPONSE_PROMPT = """\
...
- Das Ergebnis kann ein Pandas DataFrame (als String repräsentiert) oder eine Fehlermeldung sein.
- **Wenn ein DataFrame vorliegt:**
    - Analysiere die Daten im DataFrame.
    ...
    - Wenn der DataFrame leer ist (aber keine Fehlermeldung), gib an, dass keine Daten für die Kriterien gefunden wurden.
...
0       City Bikes      989052
1        Kid Bikes      826835
2   Mountain Bikes      409193
3       Race Bikes      645093
4   Trekking Bikes      417294
</datenbank_ergebnis>
<antwort>
...
---
**Beispiel 3 (Leerer DataFrame):**
<original_frage>
Umsatz der Produktlinie "E-Bikes" im Jahr 2020
</original_frage>
<datenbank_ergebnis>
Empty DataFrame
Columns: [Product_Line, TotalRevenue]
Index: []
</datenbank_ergebnis>
<antwort>
...
---
**Beispiel 4 (Umsatz für spezifischen Tag/Monat nicht gefunden):**
<original_frage>
...
**Eiserne Regel:** Deine finale Antwort darf **ausschließlich** die generierte Antwort in natürlicher Sprache enthalten, umschlossen von `<antwort>`-Tags.
- Keine Einleitung.
- Keine Erklärung.
- Kein interner Denkprozess.
- Nur die finale, saubere Antwort im XML-Tag.
"""
